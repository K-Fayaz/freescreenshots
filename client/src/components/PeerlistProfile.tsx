...
const PeerlistProfile: React.FC<PeerlistProfileProps> = ({ details, theme, logo, showMetrics }) => {
        ...
        <div className="p-6 w-full mx-auto text-center">
            ...
            <div className={`flex justify-center gap-2 mb-6 text-sm ${
                ...
                <div className="flex items-center justify-center gap-2 text-xs">
                    <svg width="16" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.49999 1.83325C13.4333 1.83325 14.6667 3.06659 14.6667 7.99992C14.6667 12.9333 13.4333 14.1666 8.49999 14.1666C3.56666 14.1666 2.33333 12.9333 2.33333 7.99992C2.33333 3.06659 3.56666 1.83325 8.49999 1.83325Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"></path><path d="M6.5 11.3334V4.66675H9.16667C9.6971 4.66675 10.2058 4.87746 10.5809 5.25253C10.956 5.62761 11.1667 6.13631 11.1667 6.66675C11.1667 7.19718 10.956 7.70589 10.5809 8.08096C10.2058 8.45603 9.6971 8.66675 9.16667 8.66675H6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"></path></svg>
                    <span>Joined {formatDate(details?.createdAt || '')}</span>
                </div>
                {details?.website && (
                    <div className="flex items-center justify-center gap-2 text-xs">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.5 14.5L14.5 9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" vector-effect="non-scaling-stroke"></path><path d="M16.8463 14.6095L19.4558 12C21.5147 9.94112 21.5147 6.60302 19.4558 4.54415C17.397 2.48528 14.0589 2.48528 12 4.54415L9.39045 7.1537M14.6095 16.8463L12 19.4558C9.94113 21.5147 6.60303 21.5147 4.54416 19.4558C2.48528 17.3969 2.48528 14.0588 4.54416 12L7.1537 9.39045" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" vector-effect="non-scaling-stroke"></path></svg>
            ...
            {details?.projects && details.projects.length > 0 && (
                <div className="mt-4 space-y-2 text-left">
                    {details.projects.map((project: any, index: number) => (
                        <div key={index} className="flex items-start gap-4 p-2 rounded-lg border-[#333333] border">
                            {/* Project Logo */}
                            ...
                            {/* <div className="flex-shrink-0 ml-auto">
                                <div className={`flex flex-col items-center gap-1 px-2 py-1 rounded border ${
                                    theme === 'Light' 
                                        ? 'border' 
                                        : 'border-orange-400 text-orange-400'
                                }`}>
                                    <Zap className="w-3 h-3" />
                                    <span className="text-sm font-medium">{project.upvotesCount}</span>
                                </div>
                            </div> */}
                            <div className="ml-4 flex flex-col items-center">
                                <div className={`${theme === 'Dark' ? 'bg-[#232428]' : 'bg-gray-100'} rounded-xl flex flex-col items-center justify-center px-4 py-3`}>
