      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-6">
              <h3 className="text-2xl font-bold font-cursive">
                Zapshot!
              </h3>
              <p className="text-gray-800 mt-2 max-w-md">
                Create beautiful, professional screenshots from your social media posts. 
                Turn tweets, threads, and profiles into shareable images instantly.
              </p>
            </div>
            <div className="flex space-x-4">
              <a href="https://x.com/zapshotin" target='_blank' className="text-gray-400 hover:text-black transition-colors">
              ...
              <a href="https://www.instagram.com/zapshotin/" target='_blank' className="text-gray-400 hover:text-black transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-700 hover:text-black text-sm transition-colors">Terms of Service</a>
              <a href="#" className="text-gray-700 hover:text-black text-sm transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
