      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-between">
        ...
        <div className="flex-1 flex flex-col justify-center items-center">
          <div className="max-w-xl w-full">
            <h1 className="text-4xl font-bold text-center mb-2">Threads Video Downloader</h1>
            <p className="mb-6 text-gray-600 text-center text-lg mt-5">Fast and free Threads video downloader. Save videos from Threads in HD MP4 format with one click.</p>
            <form onSubmit={handleFetchVideo} className="flex gap-2 max-w-2xl mx-auto">
              <input
                type="text"
                value={postUrl}
